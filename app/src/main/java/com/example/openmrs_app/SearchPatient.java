...
import com.example.openmrs_app.databinding.ActivitySearchPatientBinding;
...
public class SearchPatient extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NavController navController = Navigation.findNavController(this, R.id.nav_host_fragment_content_search_patient);
